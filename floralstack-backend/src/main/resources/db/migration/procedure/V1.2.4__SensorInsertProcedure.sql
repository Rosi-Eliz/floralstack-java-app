CREATE OR REPlACE PROCEDURE INSERT_SENSOR (p_name IN sensor.NAME%TYPE,
    ...
    IS
BEGIN
    INSERT INTO SENSOR ("NAME", "DESCRIPTION", "PRIORITY", "OUTPUT_IDENTIFIER", "UNIT_OF_MEASUREMENT", "LAST_MEASUREMENT_VALUE", "THRESHOLD_TYPE")
    VALUES (p_name, p_description, p_priority, p_output_identifier, p_unit_of_measurement,p_last_measurement_value, p_threshold_type)
